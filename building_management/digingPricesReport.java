...
public class digingPricesReport extends javax.swing.JFrame {
   ...
   String bldno;
    ...
    public digingPricesReport(javax.swing.JFrame mainFram,String bldno)throws SQLException {
        invoke = mainFram;
   ...
   quantityPerReferenceQuery = "SELECT "
            + "sum (rec_diging.total_price ) as"+ '"' + "مجموع المبالغ" + '"'+","
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("نقرير قيم مبالغ الحفريات للمحضر رقم  "+bldno);
        jLabel2.setText("نقرير قيم مبالغ الحفريات  للمحضر رقم  "+bldno);
        /*inputs*/
 ...
 private JPanel showChartPrice() {
        ...
        try {
            ...
            Logger.getLogger(digingPricesReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("  مبالغ الحفريات  للمحضر رقم  "+bldno, pieDataset,this.getWidth()/2,400);
    }
       ...
       private JPanel showBarChartQuantity() {
        ...
        return Functions.createBarChartPanel("  مبالغ الحفريات  للمحضر رقم  "+bldno,"بيان عمل الحفر","قيم المبالغ", barDataset,this.getWidth()/2,400);
    }
}
