...
public class elementPaymentReport extends javax.swing.JFrame {

 
    JFrame invoke ;
     String tableName = "payment_element_records";
    String tableKey = "elements_re_id";
   ...
   String bldno,bld_desc;
    ...
    public elementPaymentReport(javax.swing.JFrame mainFram,String bldno,String bld_desc)throws SQLException {
        invoke = mainFram;
  ...
  quantityPerReferenceQuery = "SELECT  \n"
                + " sum(payment_element_records.amount)  as \"مجموع المدفوعات \",\n"
                ...
                + "      group by  workers.worker_name";

        chartQuantityPerReferenceQuery = "SELECT "
                + " workers.worker_name as desc_,"
                + " sum(payment_element_records.amount) as  amount"
                + " FROM payment_element_records    "
                + " left join workers on payment_element_records.worker_id=workers.worker_id "
                + " where buildno='" + this.bldno + "'"
                + "      group by workers.worker_name ";
        ...
        this.setIconImage(img);   
         ...
         this.setTitle(" قيم المبالغ المدفوعة للمهنيين  المحضر "+bld_desc);
        jLabel2.setText(" قيم المبالغ المدفوعة للمهنيين المحضر "+bld_desc);
        /*inputs*/
 ...
 private JPanel showPieChart() {
        ...
        try {
            ...
            Logger.getLogger(elementPaymentReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("المبالغ المدفوعة للمهنيين المحضر "+this.bld_desc, pieDataset,this.getWidth()/2,400);
    }
       ...
       private JPanel showBarChart() {
        ...
        return Functions.createBarChartPanel("المبالغ المدفوعة  للمهنيين المحضر "+this.bld_desc,"بيان العمل","المدفوعات", barDataset,this.getWidth()/2,400);
    }
}
