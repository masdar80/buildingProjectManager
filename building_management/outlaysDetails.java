...
public class outlaysDetails extends javax.swing.JFrame {
    ...
    connect conn,conn1,inConn;
    Statement stmt;
    private final Image img;
    String bldno,bld_desc;
    
    
    public outlaysDetails(javax.swing.JFrame mainFram,String bldno,String bld_desc)throws SQLException {
        invoke = mainFram;
        ...
        */
        ...
        resultquery = "SELECT "
            ...
            + "  where buildno='"+this.bldno+"' and type_= ";
        orderby=" order by outlays_records.date_";
        initComponents();
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("مصروفات "+bld_desc);
         jLabel2.setText("قائمة المصروفات الادارية "+bld_desc);
         jLabel3.setText("قائمة المصروفات العامة "+bld_desc);
...
//        }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(adminSumJlabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(generalSumjLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private int getselectedAdmibRecordID()
{
        ...
        String desc_ = adminRecordsjTable.getValueAt(selectedRow, 5).toString();
            ...
            String[] fields1 = {"amount", "receipt_name", "receipt_no", "desc_",  "date_","buildno","type_"};
    ...
    private int getselectedGenRecordID()
{
    ...
    private void editSelected1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelected1ActionPerformed
        try {
            new addOutlays(this,bldno,"G",getselectedGenRecordID()).setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(outlaysDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void editSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelectedActionPerformed
        try {
            new addOutlays(this,bldno,"A",getselectedAdmibRecordID()).setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(outlaysDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     private void showGeneralResults() {
      ...
      adminSumJlabel.setText("");
        String chartQuantityPerReferenceQuery = "SELECT sum(amount) as amount, type_\n" +
                                            "  FROM outlays_records where buildno='"+this.bldno+"' group by type_ ";
        try {
