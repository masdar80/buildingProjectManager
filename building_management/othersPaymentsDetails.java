...
public class othersPaymentsDetails extends javax.swing.JFrame {
    ...
    public othersPaymentsDetails(javax.swing.JFrame mainFram,String bldno)throws SQLException {
        invoke = mainFram;
        ...
        this.setIconImage(img);   
         ...
         this.setTitle(" دفعات أعمال مختلفة المحضر رقم "+bldno);
    ...
    private void deleteselectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteselectedActionPerformed
          ...
          try {
              ...
              Logger.getLogger(othersPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
          }
    ...
    private int getselectedRecordID()
{
        ...
        //if(Functions.deletePrevilege){
            ...
            try {
                ...
                id = conn.searchIdwithcondition("others_", "other_id", "desc_", refereneName);
            ...
            String[] fields1 = {"amount", "receipt_name", "receipt_no", "other_id",  "date_","buildno"};
    ...
    private void editSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelectedActionPerformed
     try {
        new addOthersPayment(this,bldno,getselectedRecordID()).setVisible(true);
        } catch (SQLException ex) {
                Logger.getLogger(othersPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
