...
public class projects_manager extends javax.swing.JFrame {
    ...
    public projects_manager(javax.swing.JFrame mainFram)throws SQLException {
         invoke =mainFram;
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32)
                        .addComponent(reference, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
      ...
      // if (Functions.editPrevilege) {
        ...
        try {
           ...
           conn.QueryTable(query, DataBaseTable);
            ...
            Logger.getLogger(projects_manager.class.getName()).log(Level.SEVERE, null, ex);
        }
                emptyFields();
 ...
 // TODO add your handling code here:
    ...
    private void deleteselectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteselectedActionPerformed
        ...
        String valueIndex = DataBaseTable.getValueAt(selectedRow, 0).toString();
//if(Functions.deletePrevilege){
        String id = "";

        try {

            id = conn.searchIdwithcondition(tableName, tableKey, "name", valueIndex);
        } catch (SQLException ex) {
            Logger.getLogger(projects_manager.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (!id.equals("")) {
            ...
            showMessage("يوجد معلومات مرتبطة بهذا المشروع ولايمكن حذفه", false);
                return;
            }
        }
        conn.QueryTable(query, DataBaseTable);
    ...
    private void editSelected1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelected1ActionPerformed
        try {
            new addProject(this,getselectedRecordID()).setVisible(true);
        } catch (SQLException ex) {
    ...
    private int getselectedRecordID()
{
        ...
        name= DataBaseTable.getValueAt(selectedRow, 0).toString();
