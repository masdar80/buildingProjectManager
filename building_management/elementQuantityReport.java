...
public class elementQuantityReport extends javax.swing.JFrame {
   ...
   String bldno,bld_desc;
    ...
    public elementQuantityReport(javax.swing.JFrame mainFram,String bldno,String bld_desc)throws SQLException {
        invoke = mainFram;
   ...
   quantityPerReferenceQuery = "SELECT "
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("مجموع كمبات وكلف أعمال المهنيين للمحضر  "+bld_desc);
        jLabel2.setText("مجموع كميات وكلف أعمال المهنيين للمحضر  "+bld_desc);
        /*inputs*/
    ...
    private void initComponents() {
        ...
        jPanel2 = showChart2Quantity();
        jScrollPane3 = new javax.swing.JScrollPane();
        jPanel3 = showChartQuantity();
    ...
    private JPanel showChartQuantity() {
        ...
        try {
            ...
            Logger.getLogger(elementQuantityReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel(" كميات أعمال المهنيين للمحضر"+bld_desc, pieDataset,this.getWidth()/2,370);
    }
    ...
    private JPanel showChart2Quantity() {
        ...
        return Functions.createPieChartPanel(" تكاليف أعمال المهنيين للمحضر"+bld_desc, pieDataset,this.getWidth()/2,370);
    }
       ...
       private JPanel showBarChartQuantity() {
        ...
        try {
            ...
            while (res.next()) {
                ...
                barDataset.setValue(new Integer(res.getInt(3)),res.getString(5) +"("+res.getInt(3)+ ") " +res.getString(2), res.getString(5));
            }
        ...
        return Functions.createBarChartPanel(" كميات أعمال المهنيين للمحضر "+bld_desc,"بيان العمل","كميات", barDataset,this.getWidth()/2,370);
    }
}
