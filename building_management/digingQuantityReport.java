...
public class digingQuantityReport extends javax.swing.JFrame {
   ...
   String bldno;
    ...
    public digingQuantityReport(javax.swing.JFrame mainFram,String bldno)throws SQLException {
        invoke = mainFram;
   ...
   quantityPerReferenceQuery = "SELECT "
            + "sum (rec_diging.total_price ) as"+ '"' + "مجموع التكالبف" + '"'+","
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("مجموع كميات أعمال الحفر للمحضر رقم  "+bldno);
        jLabel2.setText("مجموع كميات أعمال الحفر للمحضر رقم  "+bldno);
        /*inputs*/
    ...
    private JPanel showChartQuantity() {
        ...
        String chartQuantityPerReferenceQuery = "SELECT "
                + "sum (rec_diging.total_price ) as price,"
        ...
        try {
            ...
            Logger.getLogger(digingQuantityReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel(" كميات أعمال الحفريات للمحضر رقم  "+bldno, pieDataset,this.getWidth()/2,370);
    }
       ...
       private JPanel showBarChartQuantity() {
        ...
        return Functions.createBarChartPanel(" كميات أعمال الحفريات للمحضر رقم  "+bldno,"اعمال حفر","كميات", barDataset,this.getWidth()/2,370);
    }
}
