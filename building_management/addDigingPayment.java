...
public class addDigingPayment extends javax.swing.JFrame {
    ...
    public addDigingPayment(javax.swing.JFrame mainFram,String bldno,int payment_id) throws SQLException {
        invoke = mainFram;
        ...
        this.setTitle("اضافة دفعة لحفريات المحضر رقم "+bldno);
        this.bldno=bldno;
    ...
    private void initComponents() {
        ...
        digingsComboBox.setNextFocusableComponent(inDate);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(digingsComboBox, 0, 110, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(digingsComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {digingsComboBox, jLabel5});
    ...
    private boolean SaveInRecord() throws SQLException {
        ...
        diging_id = conn.getIDByDesc("diging_", digingsComboBox.getSelectedItem().toString(), "desc_", "diging_id");
       ...
       //{"amount", "receipt_name", "receipt_no", "diging_id", "notice", "date_","buildno"};
    ...
    private void getPaymentInfos(int payment_id) {
       ...
       this.setTitle("تعديل دفعة حفريات للمحضر رقم "+bldno);
        try{
         ...
         System.out.println(query);
          ...
          while (recordsResultSet.next()) {
              ...
              digingsComboBox.setSelectedItem(recordsResultSet.getString(5));
              notice.setText(recordsResultSet.getString(6));
              
              
                          }
        } catch (SQLException ex) {
            Logger.getLogger(addDigingPayment.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
