...
public class digingPaymentReport extends javax.swing.JFrame {
   ...
   String bldno;
    ...
    public digingPaymentReport(javax.swing.JFrame mainFram,String bldno)throws SQLException {
        invoke = mainFram;
  ...
  quantityPerReferenceQuery = "SELECT  \n" +
                " sum(payment_diging_records.amount)  as \"مجموع المدفوعات \",\n" +
              ...
              " where buildno='"+this.bldno+"'"+
                "      group by \n" +
                "diging_.diging_id ,diging_.desc_ ";
        initComponents();
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("نقرير قيم المبالغ المدفوعة لحفريات  المحضر رقم  "+bldno);
        jLabel2.setText("نقرير قيم المبالغ المدفوعة لحفريات المحضر رقم  "+bldno);
        /*inputs*/
 ...
 private JPanel showPieChart() {
        ...
        String chartQuantityPerReferenceQuery = "SELECT " +
            " diging_.desc_ as desc_," +
            " sum(payment_diging_records.amount) as  amount" +
            "      FROM payment_diging_records    " +
            "      join diging_ on payment_diging_records.diging_id=diging_.diging_id " +
                " where buildno='"+this.bldno+"'"+
            "      group by " +
        ...
        try {
            ...
            Logger.getLogger(digingPaymentReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("المبالغ المدفوعة لحفريات المحضر "+this.bldno, pieDataset,this.getWidth()/2,400);
    }
       ...
       private JPanel showBarChart() {
        ...
        return Functions.createBarChartPanel("المبالغ المدفوعة لحفريات المحضر "+this.bldno,"الحفريات","المدفوعات", barDataset,this.getWidth()/2,400);
    }
}
