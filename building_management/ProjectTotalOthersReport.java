...
public class ProjectTotalOthersReport extends javax.swing.JFrame {
    ...
    public ProjectTotalOthersReport()throws SQLException {
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("تقرير المستحقات الكلية للاعمال المتفرقة");
    ...
    DefaultPieDataset pieDataset = new DefaultPieDataset();
         String chartQuantityPerReferenceQuery =
                 "SELECT sum(rec_others.total_price) AS amount\n" +
"                   FROM rec_others\n" +
...
"              group by buildings.desc_";
            ...
            Logger.getLogger(ProjectTotalOthersReport.class.getName()).log(Level.SEVERE, null, ex);
        }
       ...
       private JPanel showBarProjectPayment() {
        ...
        DefaultCategoryDataset barDataset = new DefaultCategoryDataset();
                String chartQuantityPerReferenceQuery ="SELECT sum(rec_others.total_price) AS amount,\n" +
"                    buildings.desc_\n" +
"                   FROM rec_others\n" +
"              LEFT JOIN buildings ON buildings.id_ = rec_others.buildno\n" +
"              group by buildings.desc_";
        ...
        return Functions.createBarChartPanel("مستحقات الاعمال المتفرقة الكلية ="+TOTAL,"المحضر","القيمة", barDataset,550,680);
    }
}
