 ...
 * @author masdar
 */
public class add_element extends javax.swing.JFrame {
    ...
    String resultquery ="SELECT "
            ...
            + " FROM rec_elements  "
            + "   join elements_ on rec_elements.element_id=elements_.element_id "
            + "   join units on units.id_ =elements_.unit_id "
            + "   join workers on workers.worker_id = rec_elements.worker_id "
           + " where re_id = ";
  int element_id=0;
    JFrame invoke ;
    String bldno,bld_desc,element_type_id,element_type_dsec;
    connect conn;
    DecimalFormat df;
    public add_element(javax.swing.JFrame mainFram,String bldno,String bld_desc,int element_id,String element_type_id,String element_type_dsec) throws SQLException {
        invoke =mainFram;
        ...
        conn.fillComboBox("workers", "worker_name",  workerssComboBox);
        this.setTitle("اإضافة بيان عمل مهني المحضر  "+bld_desc);
       bldlbl.setText(bld_desc);
        bldlbl1.setText(element_type_dsec);
        workerssComboBox.grabFocus();
         if(element_id>0)
        {
            
            getElementsInfos(element_id);
    ...
    private void initComponents() {
        ...
        workerssComboBox = new javax.swing.JComboBox();
        ...
        workerssComboBox.setNextFocusableComponent(workerssComboBox);
        workerssComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                workerssComboBoxActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(totalextField, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(workerssComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(workerssComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel3.setText("إضافة بيان عمل ");
    ...
    private void workerssComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_workerssComboBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_workerssComboBoxActionPerformed
...
if(status)
            ...
            workerssComboBox.setBackground(Color.red);
        }
...
try{
    ...
    String worker=workerssComboBox.getSelectedItem().toString();
            
    conn.fillComboBox("workers", "worker_name",  workerssComboBox);
    workerssComboBox.setSelectedItem(worker);
    ...
    private javax.swing.JComboBox workerssComboBox;
    // End of variables declaration//GEN-END:variables
      ...
      private Boolean SaveInRecord() throws SQLException {
        ...
        int worker_id = conn.getIDByDesc("workers", workerssComboBox.getSelectedItem().toString(), "worker_name", "worker_id");
       ...
       // "quantity", "price", "total_price", "date_", "element_id","buildno","notice"
...
return true;
     ...
     private Boolean UpdateRecord() throws SQLException {
        ...
        //int referenc_id = conn.getIDByDesc("elements_", workerssComboBox.getSelectedItem().toString(), "desc_", "element_id");
       int worker_id = conn.getIDByDesc("workers", workerssComboBox.getSelectedItem().toString(), "worker_name", "worker_id");
       ...
       // { "quantity", "price", "total_price", "date_", "element_id","worker_id","buildno","notice"};
        ...
        conn.updateTable(tableName, fields, values,tableKey,""+element_id);
        
return true;
    }

    
    private void getElementsInfos(int element_id) {
      this.element_id=element_id;
      this.setTitle("تعديل بيان عمل للاحضار  "+bld_desc);
       jLabel3.setText("تعديل احضار :");
        try{
          String query=resultquery+ element_id;
         ...
         System.out.println(query);
            ...
            + ", rec_elements.total_price as " + '"' + "الاجمالي" + '"'
            + ", rec_elements.price as " + '"' + "السعر" + '"'
            + ", elements_.unit  as " + '"' + "الواحدة" + '"'
            + ", rec_elements.quantity  as " + '"' + "الكمية" + '"'
            + ", elements_.desc_  as " + '"' + "بيان العمل" + '"'
            + ", elements_.worker_name  as " + '"' + "المهني" + '"'
            */
          while (recordsResultSet.next()) {
              ...
              workerssComboBox.setSelectedItem(recordsResultSet.getString(7));
//              workerssComboBox.geti
        //      workerssComboBox.setSelectedItem("محمد كريم المحمد");
