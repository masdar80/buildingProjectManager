...
public class totallProjectPaymentsPerBuldReport extends javax.swing.JFrame {
    ...
    public totallProjectPaymentsPerBuldReport()throws SQLException {
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("نقرير مدفوعات محاضر المشروع");
    ...
    DefaultPieDataset pieDataset = new DefaultPieDataset();
         String chartQuantityPerReferenceQuery =
                 "SELECT amount FROM totalpayments "; 
         String TOTAL="";
        ...
        inConn.newConnection();
         ...
         pieDataset = new DefaultPieDataset();
          chartQuantityPerReferenceQuery =
                 "SELECT amount, desc_ FROM allpayments";
            ...
            Logger.getLogger(totallProjectPaymentsPerBuldReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("المدفوعات لكل المحاضر= "+TOTAL, pieDataset,this.getWidth()/3,200);
    }
     ...
     try {
       ...
       private JPanel showBarProjectPayment() {
        ...
        DefaultCategoryDataset barDataset = new DefaultCategoryDataset();
                String chartQuantityPerReferenceQuery ="SELECT amount,desc_ FROM allpayments  ";
        try {
            stmt = inConn.conn.createStatement();
            ResultSet res = stmt.executeQuery(chartQuantityPerReferenceQuery);
            while (res.next()) {
