...
public class ProjectTotalCostsReport extends javax.swing.JFrame {
...
DecimalFormat df;
 ...
 BigDecimal TOTAL;
    ...
    public ProjectTotalCostsReport()throws SQLException {
...
df= new DecimalFormat("#.#");
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("اجمالي كلف ومصاريف المحاضر");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(RefjPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 690, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    DefaultPieDataset pieDataset = new DefaultPieDataset();
         String chartQuantityPerReferenceQuery =
                 "SELECT amount FROM fulltotalcosts "; 
     ...
     try {
        ...
        inConn.newConnection();
         ...
         pieDataset = new DefaultPieDataset();
          chartQuantityPerReferenceQuery =
                 "SELECT amount, desc_ FROM fullcosts";
        
            stmt = inConn.conn.createStatement();
             res = stmt.executeQuery(chartQuantityPerReferenceQuery);
            while (res.next()) {
         
                pieDataset.setValue(res.getString("desc_") +"("+df.format(res.getBigDecimal("amount"))+")", new Double(res.getDouble("amount")));
            }

        } catch (SQLException ex) {
            Logger.getLogger(ProjectTotalCostsReport.class.getName()).log(Level.SEVERE, null, ex);
        }
       ...
       private JPanel showBarProjectPayment() {
        ...
        DefaultCategoryDataset barDataset = new DefaultCategoryDataset();
                String chartQuantityPerReferenceQuery ="SELECT amount,desc_ FROM fullcosts  ";
        try {
            stmt = inConn.conn.createStatement();
            ResultSet res = stmt.executeQuery(chartQuantityPerReferenceQuery);
            while (res.next()) {

                barDataset.setValue(new Double(res.getDouble("amount")),res.getString("desc_") +"("+df.format(res.getBigDecimal("amount"))+")",res.getString("desc_"));
            }
        ...
        return Functions.createBarChartPanel(" مجموع كلف المحاضر ومصاريفها=\n"+df.format(TOTAL),"المحضر","الكلفة", barDataset,550,650);
    }
}
