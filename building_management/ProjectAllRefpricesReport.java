...
public class ProjectAllRefpricesReport extends javax.swing.JFrame {
    ...
    public ProjectAllRefpricesReport(javax.swing.JFrame mainFram)throws SQLException {
        invoke = mainFram;
  ...
  quantityPerReferenceQuery = "SELECT "
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("قيم  كل الاحضارات  لكل المحاضر ");
        jLabel2.setText("قيم  كل الاحضارات  لكل المحاضر ");
        /*inputs*/
 ...
 private JPanel showChartPrice() {
        ...
        try {
            ...
            Logger.getLogger(ProjectAllRefpricesReport.class.getName()).log(Level.SEVERE, null, ex);
        }
