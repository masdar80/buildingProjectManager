...
public class units_manager extends javax.swing.JFrame {
    ...
    public units_manager(javax.swing.JFrame mainFram)throws SQLException {
         invoke =mainFram;
      ...
      // if (Functions.editPrevilege) {
        ...
        try {
           ...
           conn.QueryTable(query, DataBaseTable);
            ...
            Logger.getLogger(units_manager.class.getName()).log(Level.SEVERE, null, ex);
        }
                emptyFields();
...
//if(Functions.deletePrevilege){
        ...
        if (!id.equals("")) {
            ...
            try {
               ...
               // conn.updateTable(tableName, fieldsToUpdate, valuefields, tableKey, id);
                 ...
                 showMessage("يوجد معلومات مرتبطة بهذه الواحدة ولايمكن حذفه", false);
                return;  }
        }
        conn.QueryTable(query, DataBaseTable);
    ...
    private void editSelected1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelected1ActionPerformed
        try {
            new addUnit(this,getselectedRecordID()).setVisible(true);
        } catch (SQLException ex) {
    ...
    private int getselectedRecordID()
{
        ...
        unit= DataBaseTable.getValueAt(selectedRow, 0).toString();
       ...
       return conn.getIDByCondiotonArray(tableName, fields, values,tableKey);
           } catch (SQLException ex) {
