...
public class AllRefPaymentReport extends javax.swing.JFrame {
    ...
    public AllRefPaymentReport(javax.swing.JFrame mainFram, String bldno, String bld_desc) throws SQLException {
        invoke = mainFram;
        ...
        quantityPerReferenceQuery = "select\n"
                ...
                + " where payments_records.buildno='" + this.bldno + "'\n"
        ...
        this.setTitle(" محصلة الموردين لكل الاحضارات  للمحضر " + bld_desc);
        jLabel2.setText(" محصلة الموردين لكل الاحضارات  للمحضر " + bld_desc);
        /*inputs*/
    ...
    private JPanel showPie1Chart() {
        ...
        try {
            ...
            Logger.getLogger(AllRefPaymentReport.class.getName()).log(Level.SEVERE, null, ex);
        }
