...
public class ProjectTotalOthersPaymentsReport extends javax.swing.JFrame {
    ...
    public ProjectTotalOthersPaymentsReport()throws SQLException {
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("تقرير المدفوعات الكلية للاعمال المتفرقة");
    ...
    DefaultPieDataset pieDataset = new DefaultPieDataset();
         String chartQuantityPerReferenceQuery =
                 "SELECT sum(payment_others_records.amount) AS amount\n" +
...
"              group by buildings.desc_";
            ...
            Logger.getLogger(ProjectTotalOthersPaymentsReport.class.getName()).log(Level.SEVERE, null, ex);
        }
       ...
       private JPanel showBarProjectPayment() {
        ...
        DefaultCategoryDataset barDataset = new DefaultCategoryDataset();
                String chartQuantityPerReferenceQuery ="SELECT sum(payment_others_records.amount) AS amount,\n" +
"                    buildings.desc_\n" +
"                   FROM payment_others_records\n" +
"              LEFT JOIN buildings ON buildings.id_ = payment_others_records.buildno\n" +
"              group by buildings.desc_";
        ...
        return Functions.createBarChartPanel("مدفوعات الاعمال المتفرقة الكلية ="+TOTAL,"المحضر","القيمة", barDataset,550,680);
    }
}
