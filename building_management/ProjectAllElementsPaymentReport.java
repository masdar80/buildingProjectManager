...
public class ProjectAllElementsPaymentReport extends javax.swing.JFrame {
    ...
    public ProjectAllElementsPaymentReport(javax.swing.JFrame mainFram) throws SQLException {
        invoke = mainFram;
        ...
        quantityPerReferenceQuery = "SELECT \n"
                ...
                + "  where  workers.worker_id=AA.worker_id) ,0) as \"باقي المستحقات\",\n"
                + "(SELECT  sum(payment_element_records.amount) FROM payment_element_records  \n"
                + " left join  workers on payment_element_records.worker_id = workers.worker_id \n"
                + "  where workers.worker_id=AA.worker_id) as \"اجمالي المدفوعات\",\n"
        ...
        this.setTitle(" محصلة المهنيين  في المشروع " );
        jLabel2.setText(" محصلة المهنيين   في المشروع "  );
        /*inputs*/
    ...
    private JPanel showPie1Chart() {
        ...
        try {
            ...
            Logger.getLogger(ProjectAllElementsPaymentReport.class.getName()).log(Level.SEVERE, null, ex);
        }
