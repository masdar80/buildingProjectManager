...
public class addworker extends javax.swing.JFrame {
    ...
    String query="SELECT "
            ...
            +", worker_name  as " +'"'+ "المهني" +'"'
            +" FROM workers  ";
    String cus_id="0";
   

    public addworker(javax.swing.JFrame mainFram,String id)throws SQLException {
         invoke =mainFram;
         cus_id=id;
      ...
      this.setSize(693, 215);
        this.setLocation((temp_width - 693) / 2, (temp_height - 215) / 2);
...
private void showCustomerFields() {
     ...
     String selectedCusQuery = "select "
             ...
             + "from workers where worker_id="+cus_id;
...
//    }
    ...
    private Boolean save() {
        ...
        if (!Functions.validation(customerName.getText(), 1, true)) {
            ...
            showMessage("يجب ادخال الاسم المهني",false);
        ...
        try {
            ...
            String[] values = {"'" + customerName.getText()+"'",
             ...
             conn.updateTable(tableName, fields, values, "worker_id", cus_id);
