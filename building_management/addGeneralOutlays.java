...
public class addGeneralOutlays extends javax.swing.JFrame {
    ...
    public addGeneralOutlays(javax.swing.JFrame mainFram,String type,int outlays_id) throws SQLException {
        invoke = mainFram;
        ...
        this.setTitle("اضافة/تعديل المصاريف  ");
        ...
        resultquery = "SELECT "
            ...
            + " FROM total_outlays_records  "
            + "  where  total_outlays_re_id ='"+outlays_id+"'";
