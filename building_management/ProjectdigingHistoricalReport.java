...
public class ProjectdigingHistoricalReport extends javax.swing.JFrame {
...
JFrame frame ;
    ...
    public ProjectdigingHistoricalReport() throws SQLException {
 ...
 frame = this;
        ...
        this.setTitle("نقرير عمل حفريات محدد للمشروع" );
        jLabel2.setText("نقرير عمل حفريات محدد للمشروع");
        /*inputs*/
    ...
    private JPanel showBarChartQuantity() {
        ...
        try {
            ...
            while (res.next()) {
                ...
                barDataset.setValue(new Double(res.getDouble("quantity")), res.getString("desc_")+"-"+res.getDouble("quantity"), res.getString("desc_"));
               unit=res.getString("unit");
            } 
            return Functions.createBarChartPanel(ReferenceComboBox.getSelectedItem().toString(), "بيان العمل", "كميات"+" ("+unit+")", barDataset, this.getWidth() / 2, 300);
