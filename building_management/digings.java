 ...
 * @author masdar
 */
public class digings extends javax.swing.JFrame {
    ...
    String resultquery = "SELECT "
            ...
            + "  where rec_diging.buildno=";
    
    JFrame invoke ;
    String bldno,bld_desc;
    connect conn;
    public digings(javax.swing.JFrame mainFram,String bldno,String  bld_desc) throws SQLException {
        invoke =mainFram;
   ...
   this.bld_desc=bld_desc;
        this.setTitle("حفريات "+bld_desc);
        bldlbl.setText(bld_desc);
         resultquery=resultquery+bldno+" order by rec_diging.date_";
        ShowResuls();
    }
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("مبالغ مستحقة");
        ...
        jMenuItem8.setText("مبالغ مدفوعة");
        ...
        jMenuItem9.setText("باقي المستحقات");
        ...
        jMenuItem5.setText("الكميات المشغولة");
        ...
        jMenuItem7.setText("تقرير اعمال حفر محددة");
        ...
        jMenuItem6.setText("تقرير الحفريات لواحدة محددة");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(178, 178, 178)
                        .addComponent(bldlbl, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        try{ 
              new addDigingPayment(this,this.bldno,0).setVisible(true);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
       try{ 
              new DigingpaymentsDetails(this,this.bldno).setVisible(true);
    ...
    private void editSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelectedActionPerformed
              ...
              try{
                  new add_diging(this,bldno,getselectedRecordID()).setVisible(true);
    ...
    private int getselectedRecordID()
{
   int  selectedRow = inputsRecordsjTable.getSelectedRow();
        ...
        //if(Functions.deletePrevilege){
            ...
            try {
                ...
                refer_id = conn.searchIdwithcondition("diging_", "diging_id", "desc_", refereneName);
                ...
                String[] fields1 ={ "quantity", "price", "total_price", "date_", "diging_id","buildno"};
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
     ...
     try {
         new add_diging(this,this.bldno,0).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        // TODO add your handling code here:
         ...
         try {
         new digingQuantityReport(this,this.bldno).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
         try {
         new digingHistoricalReport(this,this.bldno).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
         new digingPricesReport(this,this.bldno).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        // TODO add your handling code here:
         try {
         new digingPaymentReport(this,this.bldno).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        // TODO add your handling code here:
         try {
         new diging_balances_report(this,this.bldno).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
 ...
 try {
         new digingUnitsReport(this,this.bldno).setVisible(true);
     }catch (SQLException ex) {
                Logger.getLogger(referenciesPaymentsDetails.class.getName()).log(Level.SEVERE, null, ex);
            }
