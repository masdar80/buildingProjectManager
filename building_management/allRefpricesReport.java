...
public class allRefpricesReport extends javax.swing.JFrame {
   ...
   String bldno,bld_desc;
    ...
    public allRefpricesReport(javax.swing.JFrame mainFram,String bldno,String bld_desc)throws SQLException {
        invoke = mainFram;
  ...
  quantityPerReferenceQuery = "SELECT "
            ...
            + " references_categories.desc_  as"+ '"' + "الاحضار" + '"'+" "
            + "FROM rec_references "
            ...
            + "   group by references_categories.desc_,units.desc_";
        initComponents();
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("قيم  كل الاحضارات  للمحضر "+bld_desc);
        jLabel2.setText("قيم  كل الاحضارات  للمحضر "+bld_desc);
        /*inputs*/
 ...
 private JPanel showChartPrice() {
        ...
        try {
            ...
            Logger.getLogger(allRefpricesReport.class.getName()).log(Level.SEVERE, null, ex);
        }
