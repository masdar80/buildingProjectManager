...
public class elementPricesReport extends javax.swing.JFrame {
   ...
   String bldno,bld_desc;
    ...
    public elementPricesReport(javax.swing.JFrame mainFram,String bldno,String bld_desc)throws SQLException {
        invoke = mainFram;
   ...
   quantityPerReferenceQuery = "SELECT "
            + "sum (rec_elements.total_price ) as"+ '"' + "اجمالي المبالغ" + '"'+","
            + " units.desc_  as"+ '"' + "الواحدة" + '"'+", "
            + "sum (rec_elements.quantity )  as"+ '"' + "اجمالي الكميات" + '"'+","
           ...
           + "left join  units on elements_.unit_id = units.id_ "
            ...
            + "   group by elements_.desc_,units.desc_,workers.worker_name";
        initComponents();
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("نقرير قيم مبالغ اعمال الهنيين للمحضر "+bld_desc);
        jLabel2.setText("نقرير قيم مبالغ اعمال المهنيين  للمحضر "+bld_desc);
        /*inputs*/
    ...
    private void initComponents() {
        ...
        setTitle("نقرير قيم مبالغ الحفريات");
        setResizable(false);
 ...
 private JPanel showChartPrice() {
        ...
        String chartQuantityPerReferenceQuery = "SELECT "
                + "sum (rec_elements.total_price ) as price,"
                + "sum (rec_elements.quantity )  as quantity,"
                + " units.desc_ as unit , "
                + " elements_.desc_ "
                + "FROM rec_elements "
                + "left join  elements_ on rec_elements.element_id = elements_.element_id "
        ...
        try {
            ...
            Logger.getLogger(elementPricesReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("  مبالغ أعمال المهنيين  للمحضر رقم  "+bldno, pieDataset,this.getWidth()/2,400);
    }
       ...
       private JPanel showBarChartQuantity() {
        ...
        return Functions.createBarChartPanel("  مبالغ أعمال المهنيين  للمحضر رقم  "+bldno,"بيان عمل مهني","قيم المبالغ", barDataset,this.getWidth()/2,400);
    }
}
