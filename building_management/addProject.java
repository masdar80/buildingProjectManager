...
public class addProject extends javax.swing.JFrame {
    ...
    public addProject(javax.swing.JFrame mainFram,int _id) throws SQLException {
        invoke = mainFram;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(savein)
                .addGap(30, 30, 30)
                .addComponent(reference, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
    ...
    private Boolean UpdateRecord() throws SQLException {
            ...
            if (!Functions.validation(reference.getText(), 3, true)) {
                ...
                reference.grabFocus();
                reference.selectAll();
                showMessage("يجب ادخال اسم المشروع",false);
                return false;
                
            }

            try {
                if(conn.checkUniqField("name",reference.getText() , tableName))
                {

                    showMessage("يوجد مشروع بنفس الإسم",false);
                    return false;
                }
