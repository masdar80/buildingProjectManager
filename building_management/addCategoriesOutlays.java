...
public class addCategoriesOutlays extends javax.swing.JFrame {
    ...
    public addCategoriesOutlays(javax.swing.JFrame mainFram,String type,String project_desc,int outlays_id) throws SQLException {
        invoke = mainFram;
        ...
        this.setTitle("اضافة/تعديل المصاريف  "+ project_desc);
 ...
 String[] values = {
    ...
    private void getPaymentInfos() {
       ...
       this.setTitle(" تعديل مصاريف"+project_desc);
        try{
