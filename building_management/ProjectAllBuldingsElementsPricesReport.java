...
public class ProjectAllBuldingsElementsPricesReport extends javax.swing.JFrame {
    ...
    public ProjectAllBuldingsElementsPricesReport(javax.swing.JFrame mainFram)throws SQLException {
        invoke = mainFram;
  ...
  initComponents();
       ...
       inConn.fillComboBox("elements_", "desc_", ReferenceComboBox);
        
       this.setTitle("احصائية حسب المحاضر لبيان العمل نوع  " );
        jLabel2.setText("احصائية حسب المحاضر لبيان العمل نوع  ");
    ...
    private void showSelectedTypeResults() throws SQLException{
     int element_id = inConn.getIDByDesc("elements_", ReferenceComboBox.getSelectedItem().toString(), "desc_", "element_id");
        ...
        quantityPerReferenceQuery = "SELECT "
            ...
            + " left join  buildings on rec_elements.buildno = buildings.id_  "
            + " where rec_elements.element_id='"+element_id+"'"
            + "   group by buildings.desc_,units.desc_";

        inConn.QueryTable(quantityPerReferenceQuery, inputsRecordsjTable);

         this.setTitle("احصائية حسب المحاضر لبيان العمل نوع  " +  ReferenceComboBox.getSelectedItem().toString());
        jLabel2.setText("احصائية حسب المحاضر لبيان العمل نوع  " +  ReferenceComboBox.getSelectedItem().toString());
