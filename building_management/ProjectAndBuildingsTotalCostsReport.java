...
public class ProjectAndBuildingsTotalCostsReport extends javax.swing.JFrame {
    ...
    public ProjectAndBuildingsTotalCostsReport() throws SQLException {
        ...
        this.setTitle("اجمالي كلف ومصاريف المحاضر مضافا اليها مصاريف المشروع");

        /*inputs*/
        TOTAL = calcProjectOUtlays() + calcBuidlingsTotal();
    ...
    private Double calcBuidlingsTotal() {
        Double total1 = 0.0;
        inConn.newConnection();
        Statement stmt = null;
        String chartQuantityPerReferenceQuery = "SELECT amount FROM fulltotalcosts  ";
        try {
            stmt = inConn.conn.createStatement();
