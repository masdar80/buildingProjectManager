...
public class ProjectTotalDigRestReport extends javax.swing.JFrame {
...
DecimalFormat df;
 ...
 BigDecimal TOTAL;
    ...
    public ProjectTotalDigRestReport()throws SQLException {
...
df= new DecimalFormat("#.#");
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("تقرير باقي المستحقات الكلية للحفريات");
...
"   FROM (       SELECT rec_diging.total_price AS amount,\n" +
"                    buildings.desc_\n" +
"                   FROM rec_diging\n" +
"              LEFT JOIN buildings ON buildings.id_ = rec_diging.buildno\n" +
"        UNION ALL\n" +
"                  SELECT -1*payment_diging_records.amount,\n" +
"                    buildings.desc_\n" +
...
"                  ) a GROUP BY a.desc_";
            ...
            Logger.getLogger(ProjectTotalDigRestReport.class.getName()).log(Level.SEVERE, null, ex);
        }
...
"                  ) a GROUP BY a.desc_";
        ...
        return Functions.createBarChartPanel("باقي مستحقات الحفريات الكلية ="+df.format(TOTAL),"المحضر","القيمة", barDataset,550,680);
    }
}
