...
public class addBuilding extends javax.swing.JFrame {
    ...
    public addBuilding(javax.swing.JFrame mainFram,int _id) throws SQLException {
        invoke = mainFram;
        ...
        this._id=_id;
        this.setSize(430, 124);
        this.setLocation((temp_width - 430) / 2, (temp_height - 124) / 2);
        this.setIconImage(img);
        this.setTitle("تعديل اسم محضر");
    ...
    private void initComponents() {
        ...
        unitsComboBox1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        unitsComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "نتوف", "صوان" }));
        ...
        try{
         ...
         System.out.println(query);
          ...
          while (recordsResultSet.next()) {
              ...
              reference.setText(recordsResultSet.getString(2));
              unitsComboBox1.setSelectedItem(recordsResultSet.getString(1));
