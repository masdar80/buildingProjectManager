...
public class ProjectTotalDigPaymentsReport extends javax.swing.JFrame {
 ...
 BigDecimal TOTAL;
    ...
    public ProjectTotalDigPaymentsReport()throws SQLException {
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("تقرير المدفوعات الكلية للحفريات");
    ...
    DefaultPieDataset pieDataset = new DefaultPieDataset();
         String chartQuantityPerReferenceQuery =
                 "SELECT sum(payment_diging_records.amount) AS amount\n" +
"                   FROM payment_diging_records\n" +
"              LEFT JOIN buildings ON buildings.id_ = payment_diging_records.buildno "; 
...
"              group by buildings.desc_";
            ...
            Logger.getLogger(ProjectTotalDigPaymentsReport.class.getName()).log(Level.SEVERE, null, ex);
        }
       ...
       private JPanel showBarProjectPayment() {
        ...
        DefaultCategoryDataset barDataset = new DefaultCategoryDataset();
                String chartQuantityPerReferenceQuery ="SELECT sum(payment_diging_records.amount) AS amount,\n" +
"                    buildings.desc_\n" +
"                   FROM payment_diging_records\n" +
"              LEFT JOIN buildings ON buildings.id_ = payment_diging_records.buildno\n" +
"              group by buildings.desc_";
        ...
        return Functions.createBarChartPanel("مدفوعات الحفريات الكلية ="+df.format(TOTAL),"المحضر","القيمة", barDataset,550,680);
    }
}
