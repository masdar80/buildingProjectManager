...
public class totalOutlaysDetails extends javax.swing.JFrame {

 
    boolean state;
    JFrame invoke ;
    int other_id = 0;
    String[] fields = {"amount", "receipt_name", "receipt_no", "desc_", "notice", "date_","type_"};
    String tableName = "total_outlays_records";
    ...
    public totalOutlaysDetails(javax.swing.JFrame mainFram)throws SQLException {
        invoke = mainFram;
        ...
        */
        ...
        resultquery = "SELECT "
            + " total_outlays_records.notice as " + '"' + "ملاحظات" + '"'
            + ", total_outlays_records.receipt_no as " + '"' + "رقم الايصال" + '"'
            + ", total_outlays_records.receipt_name as " + '"' + "المستلم" + '"'
            + ", total_outlays_records.amount  as " + '"' + "القيمة" + '"'
            + ", total_outlays_records.date_  as " + '"' + "التاريخ " + '"'
            + ", total_outlays_records.desc_ as " + '"' + "بيان المصروف" + '"'
            + " FROM total_outlays_records  where type_= ";
        orderby=" order by total_outlays_records.date_ DESC";
        initComponents();
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("مصروفات عامة للمشروع");
         jLabel2.setText("قائمة مصروفات المشروع الادارية");
         jLabel3.setText("قائمة مصروفات المشروع العامة");
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("قائمة المصروفات العامة");
        ...
        jLabel2.setText("قائمة المصروفات الادارية");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(deleteselected)
                        .addComponent(add1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addGap(64, 64, 64)
    ...
    private int getselectedAdmibRecordID()
{
        ...
        String desc_ = adminRecordsjTable.getValueAt(selectedRow, 5).toString();
            ...
            String[] fields1 = {"amount", "receipt_name", "receipt_no", "desc_",  "date_","type_"};
    ...
    private int getselectedGenRecordID()
{
    ...
    private void editSelected1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelected1ActionPerformed
        try {
            new addGeneralOutlays(this,"G",getselectedGenRecordID()).setVisible(true);
        } catch (SQLException ex) {
    ...
    private void editSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editSelectedActionPerformed
        try {
            new addGeneralOutlays(this,"A",getselectedAdmibRecordID()).setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(totalOutlaysDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String whereClause = "and (total_outlays_records.notice like '%" + searchtext + "%'"
        + " or total_outlays_records.desc_ like '%" + searchtext + "%'"
        + " or total_outlays_records.receipt_no like '%" + searchtext + "%'"
        + " or total_outlays_records.receipt_name like '%" + searchtext + "%') ";

        try {
            System.out.println(resultquery+whereClause);
            connSearch2.QueryTable(resultquery+"'G'"+whereClause+orderby, generalRecordsjTable);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            System.out.println(resultquery+whereClause);
            connSearch1.QueryTable(resultquery+"'A'"+whereClause+orderby, adminRecordsjTable);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            parameters.put("", "");
            Functions.printJasperReport(parameters, "outlaysReport", true);
        } catch (NullPointerException ex) {
    ...
    private void add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add1ActionPerformed
        ...
        try {
            parameters.put("", "");
            Functions.printJasperReport(parameters, "adminoutlaysReport", true);
        } catch (NullPointerException ex) {
  ...
  private void SaveGenRecord() throws SQLException {
    ...
    private void showAdminResults() {
        try {
            ...
            conn.QueryTable(resultquery+"'A'"+orderby, adminRecordsjTable);
        }catch (NullPointerException ex) {
     ...
     private void showGeneralResults() {
        try {
            ...
            conn1.QueryTable(resultquery+"'G'"+orderby, generalRecordsjTable);
        }catch (NullPointerException ex) {
      ...
      adminSumJlabel.setText("");
        String chartQuantityPerReferenceQuery = "SELECT sum(amount) as amount, type_\n" +
                                            "  FROM total_outlays_records group by type_ ";
        try {
