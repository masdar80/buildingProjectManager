...
public class AllElementsPaymentReport extends javax.swing.JFrame {
    ...
    public AllElementsPaymentReport(javax.swing.JFrame mainFram, String bldno, String bld_desc) throws SQLException {
        invoke = mainFram;
        ...
        quantityPerReferenceQuery = "SELECT \n"
                ...
                + "  where buildno='" + this.bldno + "'  and workers.worker_id=AA.worker_id) ,0) as \"باقي المستحقات\",\n"
                + "(SELECT  sum(payment_element_records.amount) FROM payment_element_records  \n"
                + " left join  workers on payment_element_records.worker_id = workers.worker_id \n"
                + "  where buildno='" + this.bldno + "'  and workers.worker_id=AA.worker_id) as \"اجمالي المدفوعات\",\n"
                ...
                + " group by AA.worker_id,workers.worker_name";
        ...
        this.setTitle(" محصلة المهنيين لكل الاحضارات  للمحضر " + bld_desc);
        jLabel2.setText(" محصلة المهنيين لكل الاحضارات  للمحضر " + bld_desc);
        /*inputs*/
    ...
    private JPanel showPie1Chart() {
        ...
        try {
            ...
            Logger.getLogger(AllElementsPaymentReport.class.getName()).log(Level.SEVERE, null, ex);
        }
