...
public class othersPricesReport extends javax.swing.JFrame {
   ...
   String bldno;
    ...
    public othersPricesReport(javax.swing.JFrame mainFram,String bldno)throws SQLException {
        invoke = mainFram;
   ...
   this.bldno=bldno;
    quantityPerReferenceQuery = "SELECT "
            + "sum (rec_others.total_price ) as"+ '"' + "مجموع المبالغ" + '"'+","
            + " others_.unit  as"+ '"' + "الواحدة" + '"'+", "
            + "sum (rec_others.quantity )  as"+ '"' + "مجموع الكميات" + '"'+","
            
            + " others_.desc_  as"+ '"' + "بيان العمل " + '"'+" "
            + "FROM rec_others "
            + "left join  others_ on rec_others.other_id = others_.other_id "
            + " where buildno='"+this.bldno+"'"
            + "   group by others_.desc_,others_.unit";
        initComponents();
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("نقرير قيم مبالغ الاعمال المختلفة للمحضر رقم  "+bldno);
        jLabel2.setText("نقرير قيم مبالغ الاعمال المختلفة  للمحضر رقم  "+bldno);
        /*inputs*/
 ...
 private JPanel showChartPrice() {
        ...
        String chartQuantityPerReferenceQuery = "SELECT "
                + "sum (rec_others.total_price ) as price,"
                + "sum (rec_others.quantity )  as quantity,"
                + " others_.unit , "
                + " others_.desc_ "
                + "FROM rec_others "
                + "left join  others_ on rec_others.other_id = others_.other_id "
        ...
        try {
            ...
            Logger.getLogger(othersPricesReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("  مبالغ الاعمال المختلفة  للمحضر رقم  "+bldno, pieDataset,this.getWidth()/2,400);
    }
       ...
       private JPanel showBarChartQuantity() {
        ...
        return Functions.createBarChartPanel("  مبالغ الاعمال المختلفة  للمحضر رقم  "+bldno,"بيان العمل ","قيم المبالغ", barDataset,this.getWidth()/2,400);
    }
}
