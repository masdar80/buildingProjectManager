...
public class totallProjectCostPerBuldReport extends javax.swing.JFrame {
    ...
    public totallProjectCostPerBuldReport()throws SQLException {
        ...
        this.setIconImage(img);   
         ...
         this.setTitle("نقرير مستحقات محاضر المشروع");
    ...
    private void initComponents() {
        ...
        RefjPanel = showPieProjectCost();
        jPanel2 = showBarProjectCost();
    ...
    private JPanel showPieProjectCost() {
    DefaultPieDataset pieDataset = new DefaultPieDataset();
         String chartQuantityPerReferenceQuery = "SELECT amount FROM totalcosts  "; 
         String TOTAL="";
     ...
     try {
        ...
        inConn.newConnection();
         ...
         pieDataset = new DefaultPieDataset();
          chartQuantityPerReferenceQuery = "SELECT amount,desc_ FROM allcosts  "; 
            ...
            Logger.getLogger(totallProjectCostPerBuldReport.class.getName()).log(Level.SEVERE, null, ex);
        }

        return Functions.createPieChartPanel("المستحقات لكل المحاضر \n"+TOTAL, pieDataset,this.getWidth()/3,400);
    }
 
    
    
       private JPanel showBarProjectCost() {
         
        inConn.newConnection();
        Statement stmt = null;
        DefaultCategoryDataset barDataset = new DefaultCategoryDataset();
                String chartQuantityPerReferenceQuery ="SELECT amount,desc_ FROM allcosts  ";
        try {
            stmt = inConn.conn.createStatement();
            ResultSet res = stmt.executeQuery(chartQuantityPerReferenceQuery);
            while (res.next()) {
