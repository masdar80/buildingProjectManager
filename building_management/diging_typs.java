...
public class diging_typs extends javax.swing.JFrame {
    ...
    String tableName = "diging_";
    String tableKey = "diging_id";
    String query="SELECT "
            + "  unit as " +'"'+ "الواحدة" +'"'
             + " ,desc_ as " +'"'+ "بيان العمل" +'"'
            +" FROM diging_  ";

    public diging_typs(javax.swing.JFrame mainFram)throws SQLException {
         invoke =mainFram;
    ...
    private void initComponents() {
        ...
        setTitle("بيانات اعمال الحفريات");
        setResizable(false);
        ...
        jLabel1.setText("اسم بيان عمل الحفر");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(unitsComboBox1, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void DoQueryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DoQueryActionPerformed
      // if (Functions.editPrevilege) {
        ...
        if (!Functions.validation(reference.getText(), 3, true)) {
            ...
            reference.grabFocus();
            reference.selectAll();
            showMessage("يجب ادخال اسم البيان",false);
            state = false;
            return;
        }
        ...
        try {
            if(conn.checkUniqField("desc_",reference.getText() , tableName))
            {
                ...
                showMessage("يوجد بيان بنفس الإسم",false);
                return;
            }
           ...
           conn.QueryTable(query, DataBaseTable);
            ...
            Logger.getLogger(diging_typs.class.getName()).log(Level.SEVERE, null, ex);
        }
                emptyFields();
...
//if(Functions.deletePrevilege){
        ...
        if (!id.equals("")) {
            ...
            try {
             ...
             showMessage("يوجد معلومات مرتبطة بهذا البيان ولايمكن حذفه", false);
                return;}
        }
        conn.QueryTable(query, DataBaseTable);
