...
public class workersHistoricalReport extends javax.swing.JFrame {
    ...
    public workersHistoricalReport(javax.swing.JFrame mainFram, String bldno, String bld_desc) throws SQLException {
        invoke = mainFram;
        ...
        this.setTitle("نقرير لمهني محدد للمحضر  " + bld_desc);
        jLabel2.setText("نقرير  لمهني محدد للمحضر  " + bld_desc);
        /*inputs*/
        conn.fillComboBox("workers", "worker_name", ReferenceComboBox);
    ...
    private void showSelectedTypeResults() throws SQLException {
        ...
        int worker_id = conn.getIDByDesc("workers", ReferenceComboBox.getSelectedItem().toString(), "worker_name", "worker_id");
        ...
        quantityPerReferenceQuery = "SELECT "
            ...
            + " and rec_elements.worker_id= " + worker_id
            + " group by date_,workers.worker_name,elements_.desc_,units.desc_  order by  date_ ";
