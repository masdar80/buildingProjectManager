...
public class referenciesSubTypes extends javax.swing.JFrame {
    ...
    public referenciesSubTypes(javax.swing.JFrame mainFram)throws SQLException {
       ...
       // this.setMaximumSize(new Dimension(680, 530));
        ...
        this.setLocation((temp_width - 480) / 2, (temp_height - 400) / 2);
        this.setIconImage(img);
        reference.grabFocus();
        DataBaseTable.setVisible(false);
        conn = new connect();
        conn.newConnection();
        conn.fillComboBox("references_categories", "desc_", unitsComboBox1);
      ...
      // if (Functions.editPrevilege) {
       ...
       // unit.setBackground(Color.white);
        ...
        if (!Functions.validation(reference.getText(), 3, true)) {
            ...
            reference.grabFocus();
            reference.selectAll();
            showMessage("يجب ادخال اسم بند الاحضار",false);
            state = false;
            return;
        }
        ...
        try {
            if(conn.checkUniqField("desc_",reference.getText() , tableName))
            {
                ...
                showMessage("يوجد بند احضار بنفس الإسم",false);
                return;
            }
            int catID=conn.getIDByDesc("references_categories", unitsComboBox1.getSelectedItem().toString(), "desc_", "reference_id");
           ...
           conn.QueryTable(query, DataBaseTable);
            ...
            Logger.getLogger(referenciesSubTypes.class.getName()).log(Level.SEVERE, null, ex);
        }
                emptyFields();
...
//if(Functions.deletePrevilege){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            new referencies_typs(this).setVisible(true);
